...
public class DirectoryConnector {
	...
	public String[] getUserList() throws IOException {
		...
		if (respuestaMensaje.getOperation().equals(NFDirectoryServer.LIST_OK)) {
			...
			System.err.println("Debes estar loggeado para ver los usuarios activos.");
		}
		return userlist;
	}
	...
	public boolean logoutFromDirectory() throws IOException {
		...
		if (respuestaMensaje.getOperation().equals(NFDirectoryServer.LOGOUT_OK)) {
			...
			System.out.println("Logout exitoso. Hasta la próxima!");
			success = true;
		} else {
			System.err.println("Logout fallido. Debes estar loggeado, para desloggearte.");
		}
		return success;
	}
