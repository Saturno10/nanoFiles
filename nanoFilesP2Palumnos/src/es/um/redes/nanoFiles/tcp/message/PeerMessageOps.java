...
public class PeerMessageOps {
	...
	public static final byte OPCODE_FILELIST = 3;
	public static final byte OPCODE_DOWNLOAD_OK = 4;
	public static final byte OPCODE_FILELIST_OK = 5;
	...
	private static final Byte[] _valid_opcodes = {
			OPCODE_INVALID_CODE,OPCODE_FILE_NOT_FOUND, OPCODE_DOWNLOAD,
			OPCODE_DOWNLOAD_FROM, OPCODE_FILELIST, OPCODE_DOWNLOAD_OK, OPCODE_FILELIST_OK



			};
	private static final String[] _valid_operations_str = {
			"INVALID_OPCODE", "FILE_NOT_FOUND","DOWNLOAD","DOWNLOAD_FROM", "FILELIST",
			"DOWNLOAD_OK","FILELIST_OK"
