		...
		try {
			...
			while(socket.isConnected()) {
				...
				case PeerMessageOps.OPCODE_DOWNLOAD_FROM:
					System.out.println("Solicitud de descarga recibida");
					...
					case 1:
						...
						File fichero = new File(NanoFiles.db.lookupFilePath(coincidencias[0].filePath));
					...
					default:
						System.out.println("Solicitud ambigua");
				...
				default:
					System.err.println("Solicitud no reconocida");
					break;
				}
