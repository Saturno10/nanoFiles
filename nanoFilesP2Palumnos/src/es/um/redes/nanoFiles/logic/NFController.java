...
public class NFController {
	...
	public boolean canProcessCommandInCurrentState() {
		...
		case NFCommands.COM_LOGIN:
			//Quitar if si se quiere poder iniciar varias sesiones con el mismo nanofiles
		...
		case NFCommands.COM_LOGOUT:
			if (currentState != LOGGED_IN) {
				commandAllowed = false;
				System.err.println("* You cannot logout because you are not logged in the directory to begin with");
			}
			break;
