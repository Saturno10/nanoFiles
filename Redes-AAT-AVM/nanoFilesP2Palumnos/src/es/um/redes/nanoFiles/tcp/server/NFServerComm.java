			...
			while(socket.isConnected() && !socket.isClosed()) {	
				...
				case PeerMessageOps.OPCODE_DOWNLOAD_FROM:
					...
					default:
						...
						String hashesPosibles = "";
						String nombresPosibles = "";
						for (FileInfo f : coincidencias) {
							hashesPosibles += f.fileHash + ":";
							nombresPosibles += f.fileName + ":";
						}
						answerMessage.setHash(hashesPosibles);
						answerMessage.setFileName(nombresPosibles);
						break;
					}
